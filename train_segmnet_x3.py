...
from models import create_segmnet_x3
...
if __name__ == '__main__':
    ...
    pretrained_model = None # './train/segment/model_e10.pth'
    ...
    loader_train = LTRLoader('train', dataset_train, training=True, batch_size=batch_size, num_workers=8, shuffle=True, drop_last=True, stack_dim=1)
    ...
    # Create model
    net = create_segmnet_x3(pretrained_backbone=True)
