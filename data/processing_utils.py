...
def centered_crop(frames, anno, area_factor, output_sz, pad_val=None):
    crops_resize_factors = [sample_target(f, a, area_factor, output_sz, pad_val=pad_val)
    ...
    return frames_crop, anno_crop, resize_factors
